...
function navbar_entry($entry, $level = 1)
{
  ...
  elseif (isset($entry['userlevel']) && isset($_SESSION['userlevel']) && $_SESSION['userlevel'] < $entry['userlevel'])
  {
     // skip not permitted menu items
     return;
  }
  elseif (OBSERVIUM_EDITION === 'community' && isset($entry['community']) && $entry['community'] === FALSE)
  {
     // Skip not exist features on community
     return;
  }

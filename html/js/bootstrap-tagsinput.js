 ...
 *
 * Additional fixes:
 * - https://github.com/bootstrap-tagsinput/bootstrap-tagsinput/pull/355
 * - https://github.com/bootstrap-tagsinput/bootstrap-tagsinput/pull/364
 * - https://github.com/bootstrap-tagsinput/bootstrap-tagsinput/pull/396
 * Added by Observium Developers:
 * - disabled/readonly attribs
 * - fixed issue with input special chars
 * - trim double quotes
 */
(function ($) {
  "use strict";
  ...
  TagsInput.prototype = {
    ...
    add: function(item, dontPushVal, options) {
      ...
      var optionExists = (
        $('option[value="' + encodeURIComponent(itemValue).replace(/([ #;&,.+*~\':"!^$[\]()=>|\/\\@])/g,'\\$1') + '"]', self.$element).length ||
        $('option[value="' + htmlEncode(itemValue).replace(/([ #;&,.+*~\':"!^$[\]()=>|\/\\@])/g,'\\$1') + '"]', self.$element).length
      );
    ...
    refresh: function() {
      ...
      // Add/clean disabled/readonly attribs
      if (this.$element.prop('disabled') || this.$element.prop('readonly')) {
        this.$container.addClass('disabled');

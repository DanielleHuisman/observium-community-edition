...
// jscs:enable requireCamelCaseOrUpperCaseIdentifiers
    ...
    var d = window, e = function (a, b, c) {
        ...
        }, removePositioningStyles: function (a) {
            var b = a[0].style;
            b.position && b.removeProperty("position"), b.left && b.removeProperty("left"), b.top && b.removeProperty("top"), b.width && b.removeProperty("width"), b.height && b.removeProperty("height")
        }
    };
...
// For Meteor support: https://github.com/troolee/gridstack.js/pull/272
        ...
        this._sortNodes(), this["float"] ? b.each(this.nodes, b.bind(function (a, c) {
            if (!a._updating && "undefined" != typeof a._origY && a.y != a._origY) for (var d = a.y; d >= a._origY;) {
        ...
        if (a[0] = "undefined" == typeof a[0] ? [] : [a[0]], a[1] = "undefined" == typeof a[1] ? !0 : a[1], !this._updateCounter) {
        ...
        c = "undefined" == typeof c ? !0 : c, this._removedNodes.push(b.clone(a)), a._id = null, this.nodes = b.without(this.nodes, a), this._packNodes(), this._notify(a, c)
        ...
        return "number" != typeof b && (b = a.x), "number" != typeof c && (c = a.y), "number" != typeof d && (d = a.width), "number" != typeof e && (e = a.height), "undefined" != typeof a.maxWidth && (d = Math.min(d, a.maxWidth)), "undefined" != typeof a.maxHeight && (e = Math.min(e, a.maxHeight)), "undefined" != typeof a.minWidth && (d = Math.max(d, a.minWidth)), "undefined" != typeof a.minHeight && (e = Math.max(e, a.minHeight)), a.x != b || a.y != c || a.width != d || a.height != e
    ...
    var j = function (d, e) {
        ...
        if (this.opts = b.defaults(e || {}, {
            ...
            this.container.children("." + this.opts.itemClass + ":not(." + this.opts.placeholderClass + ")").each(function (b, c) {
                c = a(c), m.push({
                    el: c,
                    i: parseInt(c.attr("data-gs-x")) + parseInt(c.attr("data-gs-y")) * n.opts.width
                })
            }), b.chain(m).sortBy(function (a) {
                return a.i
            }).each(function (a) {
                k._prepareElement(a.el)
            }).value()
        }
        if (this.setAnimation(this.opts.animate), this.placeholder = a('<div class="' + this.opts.placeholderClass + " " + this.opts.itemClass + '"><div class="placeholder-content">' + this.opts.placeholderText + "</div></div>").hide(), this._updateContainerHeight(), this._updateHeightsOnResize = b.throttle(function () {
            k.cellHeight(k.cellWidth(), !1)
        }, 100), this.onResizeHandler = function () {
            if (j && k._updateHeightsOnResize(), k._isOneColumnMode() && !k.opts.disableOneColumnMode) {
                if (h) return;
                k.container.addClass(k.opts.oneColumnModeClass), h = !0, k.grid._sortNodes(), b.each(k.grid.nodes, function (a) {
                    k.container.append(a.el), k.opts.staticGrid || (k.dd.draggable(a.el, "disable"), k.dd.resizable(a.el, "disable"), a.el.trigger("resize"))
                })
            } else {
                if (!h) return;
                if (k.container.removeClass(k.opts.oneColumnModeClass), h = !1, k.opts.staticGrid) return;
                b.each(k.grid.nodes, function (a) {
                    a.noMove || k.opts.disableDrag || k.dd.draggable(a.el, "enable"), a.noResize || k.opts.disableResize || k.dd.resizable(a.el, "enable"), a.el.trigger("resize")
                })
            }
        }, a(window).resize(this.onResizeHandler), this.onResizeHandler(), !k.opts.staticGrid && "string" == typeof k.opts.removable) {
            var o = a(k.opts.removable);
            this.dd.isDroppable(o) || this.dd.droppable(o, {accept: "." + k.opts.itemClass}), this.dd.on(o, "dropover", function (b, c) {
                var d = a(c.draggable), e = d.data("_gridstack_node");
                e._grid === k && k._setupRemovingTimeout(d)
            }).on(o, "dropout", function (b, c) {
                var d = a(c.draggable), e = d.data("_gridstack_node");
                e._grid === k && k._clearRemovingTimeout(d)
            })
        }
        if (!k.opts.staticGrid && k.opts.acceptWidgets) {
            var p = null, q = function (a, b) {
                var c = p, d = c.data("_gridstack_node"), e = k.getCellFromPixel(b.offset, !0), f = Math.max(0, e.x),
                    g = Math.max(0, e.y);
                if (d._added) {
                    if (!k.grid.canMoveNode(d, f, g)) return;
                    k.grid.moveNode(d, f, g), k._updateContainerHeight()
                } else d._added = !0, d.el = c, d.x = f, d.y = g, k.grid.cleanNodes(), k.grid.beginUpdate(d), k.grid.addNode(d), k.container.append(k.placeholder), k.placeholder.attr("data-gs-x", d.x).attr("data-gs-y", d.y).attr("data-gs-width", d.width).attr("data-gs-height", d.height).show(), d.el = k.placeholder, d._beforeDragX = d.x, d._beforeDragY = d.y, k._updateContainerHeight()
            };
            this.dd.droppable(k.container, {
                accept: function (b) {
                    b = a(b);
                    var c = b.data("_gridstack_node");
                    return c && c._grid === k ? !1 : b.is(k.opts.acceptWidgets === !0 ? ".grid-stack-item" : k.opts.acceptWidgets)
                }
            }).on(k.container, "dropover", function (b, c) {
                var d = (k.container.offset(), a(c.draggable)), e = k.cellWidth(), f = k.cellHeight(),
                    g = d.data("_gridstack_node"), h = g ? g.width : Math.ceil(d.outerWidth() / e),
                    i = g ? g.height : Math.ceil(d.outerHeight() / f);
                p = d;
                var j = k.grid._prepareNode({width: h, height: i, _added: !1, _temporary: !0});
                d.data("_gridstack_node", j), d.data("_gridstack_node_orig", g), d.on("drag", q)
            }).on(k.container, "dropout", function (b, c) {
                var d = a(c.draggable);
                if (d.data("_gridstack_node")) {
                    d.unbind("drag", q);
                    var e = d.data("_gridstack_node");
                    e.el = null, k.grid.removeNode(e), k.placeholder.detach(), k._updateContainerHeight(), d.data("_gridstack_node", d.data("_gridstack_node_orig"))
                }
            }).on(k.container, "drop", function (b, c) {
                k.placeholder.detach();
...
// jscs:enable requireCamelCaseOrUpperCaseIdentifiers
    return j.prototype._triggerChangeEvent = function (a) {
        ...
        if (null !== this._styles && "undefined" != typeof this._styles) {
            ...
            if ("undefined" == typeof a && (a = this._styles._max), !(0 !== this._styles._max && a <= this._styles._max) && (this._initStyles(), this._updateContainerHeight(), this.opts.cellHeight && (b = this.opts.verticalMargin && this.opts.cellHeightUnit !== this.opts.verticalMarginUnit ? function (a, b) {
                ...
                for (var e = this._styles._max; a > e; ++e) g.insertCSSRule(this._styles, c + '[data-gs-height="' + (e + 1) + '"]', "height: " + b(e + 1, e) + ";", e), g.insertCSSRule(this._styles, c + '[data-gs-min-height="' + (e + 1) + '"]', "min-height: " + b(e + 1, e) + ";", e), g.insertCSSRule(this._styles, c + '[data-gs-max-height="' + (e + 1) + '"]', "max-height: " + b(e + 1, e) + ";", e), g.insertCSSRule(this._styles, c + '[data-gs-y="' + e + '"]', "top: " + b(e, e) + ";", e);
                this._styles._max = a
            }
        }
    }, j.prototype._updateContainerHeight = function () {
        if (!this.grid._updateCounter) {
            var a = this.grid.getGridHeight(), b = parseInt(this.container.css("min-height")) / this.cellHeight();
...
// width and height are undefined if not resizing
            var l = "undefined" != typeof h ? h : c.lastTriedWidth, m = "undefined" != typeof i ? i : c.lastTriedHeight;
            ...
            var h = a(this);
            if (h.data("_gridstack_node")) {
                var i = !1;
                if (f.placeholder.detach(), c.el = h, f.placeholder.hide(), c._isAboutToRemove) {
                    i = !0;
                    var j = b.data("_gridstack_node")._grid;
                    j._triggerRemoveEvent(), b.removeData("_gridstack_node"), b.remove()
                } else f._clearRemovingTimeout(b), c._temporaryRemoved ? (g.removePositioningStyles(h), h.attr("data-gs-x", c._beforeDragX).attr("data-gs-y", c._beforeDragY).attr("data-gs-width", c.width).attr("data-gs-height", c.height), c.x = c._beforeDragX, c.y = c._beforeDragY, f.grid.addNode(c)) : (g.removePositioningStyles(h), h.attr("data-gs-x", c.x).attr("data-gs-y", c.y).attr("data-gs-width", c.width).attr("data-gs-height", c.height));
                f._updateContainerHeight(), f._triggerChangeEvent(i), f.grid.endUpdate();
                var k = h.find(".grid-stack");
                k.length && "resizestop" == d.type && (k.each(function (b, c) {
                    a(c).data("gridstack").onResizeHandler()
                }), h.find(".grid-stack-item").trigger("resizestop"), h.find(".grid-stack-item").trigger("gsresizestop")), "resizestop" == d.type && f.container.trigger("gsresizestop", h)
            }
        };
        this.dd.draggable(b, {start: i, stop: j, drag: h}).resizable(b, {
            start: i,
            stop: j,
            resize: h
        }), (c.noMove || this._isOneColumnMode() && !f.opts.disableOneColumnMode || this.opts.disableDrag || this.opts.staticGrid) && this.dd.draggable(b, "disable"), (c.noResize || this._isOneColumnMode() && !f.opts.disableOneColumnMode || this.opts.disableResize || this.opts.staticGrid) && this.dd.resizable(b, "disable"), b.attr("data-gs-locked", c.locked ? "yes" : null)
        ...
        var e = d.grid.addNode({
            ...
            resizeHandles: b.attr("data-gs-resize-handles"),
            el: b,
        ...
        c = "undefined" == typeof c ? !0 : c, b = a(b);
...
// For Meteor support: https://github.com/troolee/gridstack.js/pull/272
        ...
        a(window).off("resize", this.onResizeHandler), this.disable(), "undefined" == typeof b || b ? this.container.remove() : (this.removeAll(!1), this.container.removeData("gridstack")), g.removeStylesheet(this._stylesId), this.grid && (this.grid = null)
    }, j.prototype.resizable = function (b, c) {
        var d = this;
        return b = a(b), b.each(function (b, e) {
            e = a(e);
            var f = e.data("_gridstack_node");
            "undefined" != typeof f && null !== f && (f.noResize = !c, f.noResize || d._isOneColumnMode() && !d.opts.disableOneColumnMode ? d.dd.resizable(e, "disable") : d.dd.resizable(e, "enable"))
        }), this
        ...
        return b = a(b), b.each(function (b, e) {
            e = a(e);
            var f = e.data("_gridstack_node");
            "undefined" != typeof f && null !== f && (f.noMove = !c, f.noMove || d._isOneColumnMode() && !d.opts.disableOneColumnMode ? (d.dd.draggable(e, "disable"), e.removeClass("ui-draggable-handle")) : (d.dd.draggable(e, "enable"), e.addClass("ui-draggable-handle")))
        }), this
        ...
        var c = "undefined" != typeof b && b ? this.container.offset() : this.container.position(), d = a.left - c.left,
 ...
 */
    function (a) {
        ...
        return c.GridStackDragDropPlugin.registerPlugin(d), d.prototype = Object.create(c.GridStackDragDropPlugin.prototype), d.prototype.constructor = d, d.prototype.resizable = function (c, d) {
            if (c = a(c), "disable" === d || "enable" === d) c.resizable(d); else if ("option" === d) {
                var e = arguments[2], f = arguments[3];
                c.resizable(d, e, f)
            } else {
                var g = c.data("gs-resize-handles") ? c.data("gs-resize-handles") : this.grid.opts.resizable.handles;
                c.resizable(b.extend({}, this.grid.opts.resizable, {handles: g}, {

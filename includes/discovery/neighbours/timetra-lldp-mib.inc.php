...
$lldpRemTable_oids = ['tmnxLldpRemChassisIdSubtype', 'tmnxLldpRemChassisId', 'tmnxLldpRemPortIdSubtype',
                      'tmnxLldpRemPortId', 'tmnxLldpRemPortDesc', 'tmnxLldpRemSysName'];
$lldp_array        = [];
foreach ($lldpRemTable_oids as $oid) {
    $lldp_array = snmpwalk_cache_oid($device, $oid, $lldp_array, "TIMETRA-LLDP-MIB");

...
$oids = snmpwalk_cache_oid($device, 'boxServicesStackTempSensorsTable', [], 'OLD-DNOS-BOXSERVICES-PRIVATE-MIB');
...
foreach ($oids as $index => $entry) {
    ...
    discover_status($device, $oid, "boxServicesStackTempSensorState.$index", 'fastpath-boxservices-private-temp-state', $descr, $value, ['entPhysicalClass' => 'temperature']);
}
...
if (!$boxServicesStackTempSensorsTable) {
    ...
    $oids = snmpwalk_cache_oid($device, 'boxServicesTempSensorsTable', [], 'OLD-DNOS-BOXSERVICES-PRIVATE-MIB');

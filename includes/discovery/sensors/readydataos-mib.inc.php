...
$cache['readydataos-mib']['diskTable'] = snmpwalk_cache_oid($device, 'diskTable', [], 'READYDATAOS-MIB');
...
$cache['readydataos-mib']['temperatureTable'] = snmpwalk_cache_oid($device, 'temperatureTable', [], 'READYDATAOS-MIB');

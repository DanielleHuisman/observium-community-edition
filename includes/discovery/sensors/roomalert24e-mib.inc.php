...
$oids = snmpwalk_cache_oid($device, "humidity", [], "ROOMALERT24E-MIB");
...
foreach ($oids as $index => $entry) {
    ...
    discover_sensor('humidity', $device, $oid, "internal-humidity.$index", 'roomalert', $descr, $scale, $value);
}

// Internal Temperature
// ROOMALERT24E-MIB::internal-tempf.0 = INTEGER: 68
// ROOMALERT24E-MIB::internal-tempc.0 = INTEGER: 20
$oids = snmpwalk_cache_oid($device, "internal-tempc", [], "ROOMALERT24E-MIB");
...
$oids = snmpwalk_cache_oid($device, "digital", [], "ROOMALERT24E-MIB");

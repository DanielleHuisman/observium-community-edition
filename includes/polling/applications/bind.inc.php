...
if (!empty($agent_data['app']['bind']['global'])) {
    ...
    // Prepare data arrays
    // -------------------
    $rrtypes = ['SOA', 'ANY', 'A', 'AAAA', 'NS', 'MX', 'CNAME', 'DNAME', 'TXT', 'SPF', 'SRV', 'SSHFP', 'TLSA', 'IPSECKEY', 'PTR', 'DNSKEY', 'RRSIG', 'NSEC', 'NSEC3', 'NSEC3PARAM', 'DS', 'DLV', 'IXFR', 'AXFR'];
    ...
    // req-in
    rrdtool_update_ng($device, 'bind-req-in', [
      'query'  => $req_in['QUERY'],
